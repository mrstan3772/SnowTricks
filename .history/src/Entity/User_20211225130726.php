 ...
 * @UniqueEntity(fields="email"},message="Il existe déjà un compte avec ce nom d'utilisateur ou cette adresse e-mail.")
 * @UniqueEntity(fields={"username"},message="Il existe déjà un compte avec ce nom d'utilisateur ou cette adresse e-mail.")
 */
