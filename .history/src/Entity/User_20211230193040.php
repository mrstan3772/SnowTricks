 ...
 * @UniqueEntity(fields="email",message="Il existe déjà un compte avec cette adresse e-mail.",groups={"registration"})
 * @UniqueEntity(fields="username",message="Il existe déjà un compte avec ce nom d'utilisateur.",groups={"registration"})
 */
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     */
    private $forgotPasswordTokenRequestAt;
    ...
    public function getForgotPasswordTokenRequestAt(): ?\DateTimeImmutable
    {
        return $this->forgotPasswordTokenRequestAt;
    }

    public function setForgotPasswordTokenRequestAt(?\DateTimeImmutable $forgotPasswordTokenRequestAt): self
    {
        $this->forgotPasswordTokenRequestAt = $forgotPasswordTokenRequestAt;
