...
final class TrickFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'trick_author_id' => self::faker()->randomNumber(),
            'trick_name' => self::faker()->text(),
            'trick_description' => self::faker()->text(),
            'trick_group_id' => self::faker()->randomNumber(),
            'trick_creation_date' => null, // TODO add DATETIME ORM type manually
